...
var styleTask = function(stylesPath, srcs) {
  return gulp.src(srcs.map(function(src) {
    ...
    .pipe(gulp.dest('../../public/polymer/' + stylesPath))
    .pipe($.minifyCss())
...
var optimizeHtmlTask = function(src, dest) {
  var assets = $.useref.assets({
    searchPath: ['../../public/polymer/', '../../public/dist/polymer']
  });
...
gulp.task('vulcanize', function() {
  return gulp.src('../../public/polymer/elements/elements.html')
    .pipe($.vulcanize({
      stripComments: true,
      inlineCss: true,
      inlineScripts: true
...
gulp.task('js', function () {
 return gulp.src(['app/**/*.{js,html}', '!app/bower_components/**/*'])
   ...
   .pipe(gulp.dest('../../public/dist/polymer/'));
});
